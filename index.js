...
function getConfig(userIDs, hostName, proxyIP) {
	const commonUrlPart = `?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fmulancloud#${hostName}`;
	...
	const htmlHead = `
  <head>
    <title>MULANCLOUD: Configuration</title>
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <meta property='og:site_name' content='MULANCLOUD: Protocol Configuration' />
    <meta property='og:type' content='website' />
    <meta property='og:title' content='MULANCLOUD - Protocol Configuration and Subscribe Output' />
    ...
    <meta name='twitter:title' content='MULANCLOUD - Protocol Configuration and Subscribe Output' />
...
function GenSub(userID_path, hostname, proxyIP) {
	...
	const randomPath = () => '/' + Math.random().toString(36).substring(2, 15) + '?mulancloud';
	const commonUrlPartHttp = `?encryption=none&security=none&fp=random&type=ws&host=${hostname}&path=${encodeURIComponent(randomPath())}#`;
	const commonUrlPartHttps = `?encryption=none&security=tls&sni=${hostname}&fp=random&type=ws&host=${hostname}&path=%2F%3Fmulancloud#`;
